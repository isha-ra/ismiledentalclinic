...
<section class="blog_w3ls py-lg-5">
    <div class="container">
        @php
            $feedback = App\Model\FeedbackModel\Feedback::paginate(3);
        @endphp
        <div class="title-section text-center pb-lg-5">
            <h4>world of medicine</h4>
        ...
        <div class="row py-5">
            ...
            @foreach($feedback  as $feed)
                <div class="col-lg-4 col-md-6">
                    <div class="card border-0 med-blog">
                        <div class="card-header p-0" style="color: lightskyblue;">
                        ...
                        <div class="card-body border-0 px-0">
                            <div class="blog_w3icon">
                                <span  style="color: black;">
                                    Patient's words:- {{$feed->msg}}</span>
                            </div>
                            <div class="pt-2">
                                <h5 class="blog-title card-title font-weight-italic" style="color: grey;">

                                        {!! substr($feed->created_at,0,10) !!}
                                </h5>
                            </div>
        ...
        <div class="row m-0 p-0 text-center">
            <div class="container text-center mt-5">
                <a href="/feed" class="rju-btn btn-1 theme-white-color" style=" ">
                    <svg>
