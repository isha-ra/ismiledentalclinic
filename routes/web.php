...
Route::get('/feed','Home\HomeController@feed');
...
//contact
    ...
    Route::post('/contact-delete/{id}','Contact\ContactController@destroy');
...
//Gallery
    ...
    Route::post('/gallery-delete/{id}','Gallery\GalleryController@destroy');
